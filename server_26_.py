        ...
        while True:
            ...
            if comnd == "upload":
                if state[0] == "C":
                    ...
                    c,code = state.split("@")
                    my_files.append(File(filename,"open",code))
                    save_file("data/saved.csv",filename,"open",code)
                else:
                    #this will be when the file is open
                    my_files.append(File(filename,"locked",0))
                    save_file("data/saved.csv",filename,"locked",0)
